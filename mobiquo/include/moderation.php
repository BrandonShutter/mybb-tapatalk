...
{
    global $input, $thread, $forum, $tid, $fid, $modlogdata, $lang, $plugins, $mybb;
...
{
    global $input, $post, $thread, $forum, $pid, $tid, $fid, $modlogdata, $db, $lang, $plugins, $mybb, $moderation;
    ...
    if($firstcheck['pid'] == $pid)
    {
        if($forumpermissions['candeletethreads'] == 1 || is_moderator($fid, "candeletethreads") || is_super_admin($mybb->user['uid']))
        {
            ...
            else if ($mybb->settings['soft_delete'] == 1 || is_moderator($fid, "cansoftdeletethreads"))
            {
    ...
    else
    {
        if($forumpermissions['candeleteposts'] == 1 || is_moderator($fid, "candeleteposts") || is_super_admin($mybb->user['uid']))
        {
            ...
            else if($mybb->settings['soft_delete'] == 1 || is_moderator($fid, "cansoftdeleteposts"))
            {
